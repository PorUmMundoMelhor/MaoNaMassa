package com.maonamassa.security.service;

import com.maonamassa.persistence.model.ApplicationUser;
import com.maonamassa.persistence.repository.ApplicationUserRepository;
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public ApplicationUser loadApplicationUserByUsername(String username) {
        return Optional.ofNullable(applicationUserRepository.findByUsername(username))
                .orElseThrow(() -> new UsernameNotFoundException("AplicationUser not found"));
    }
